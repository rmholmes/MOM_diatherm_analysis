...
% $$$          {'ACCESS-OM2_1deg_jra55_ryf8485',[394]}, ...
% $$$     {'ACCESS-OM2_1deg_jra55_ryf9091_kds50',[45]}, ...
% $$$     {'ACCESS-OM2_1deg_jra55_ryf9091_kds75',[16]}, ...
% $$$     {'ACCESS-OM2_1deg_jra55_ryf9091_kds135',[12]}, ...
       };
...
% $$$ outputs = [111 222];
base = '/srv/ccrc/data03/z3500785/mom/mat_data/';
model = 'ACCESS-OM2_1deg_jra55_ryf9091_kds135';
outputs = [12];
load([base model sprintf('_output%03d_BaseVars.mat',outputs(1))]);
ndays = diff(time_snap);
...
title('ACCESS-OM2 1-degree KDS135 Eq Pacific T bias ($^\circ$C)');
% $$$ 
%%% M-L T-t plots: 
months = 1:12;
fields = {
