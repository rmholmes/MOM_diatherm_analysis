...
fields = { ...
          ...
          {SUB(:,months,yrs), 'Submesoscale','c',2,'--'}, ...
          {N(:,months,yrs), 'Monthly Snapshot Tendency $\partial\mathcal{H}_I/\partial t$','m',2,'-'}, ...
...
% $$$ fields = { ...
% $$$           {F(:,months,yrs)+PI(:,months,yrs), 'Surface Forcing $F+P_I$','k',2,'-'}, ...
% $$$           {M(:,months,yrs)+MD(:,months,yrs)+SG(:,months,yrs), 'Vertical Mixing + NL + Mix-downslope + Sigma-diff','r',2,'-'}, ...
% $$$           {GM(:,months,yrs)+SUB(:,months,yrs), 'GM+SUB','c',2,'-'}, ...
% $$$           {I(:,months,yrs), 'Numerical Mixing $\mathcal{I}$','b',2,'-'}, ...
% $$$           {I(:,months,yrs)+GM(:,months,yrs)+SUB(:,months,yrs), 'Numerical Mixing $\mathcal{I}$+GM+SUB','g',2,'-'}, ...
% $$$           {NUM(:,months,yrs), 'Numerical Mixing direct','b',2,'--'}, ...
...
% $$$ % FUll fields for numerical checks:
% $$$ fields = { ...
...
% $$$           {TEN(:,months,yrs), 'Eulerian Tendency','k',1,'--'}, ...
% $$$           {ADV(:,months,yrs), 'Eulerian Advection','b',1,'--'}, ...
% $$$           {ADV(:,months,yrs)-TEN(:,months,yrs), 'Eulerian Advection - Tendency','m',1,'--'}, ...
