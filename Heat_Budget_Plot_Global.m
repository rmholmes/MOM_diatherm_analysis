...
% $$$           {VDFkppbl(:,months,yrs), 'Vertical Diffusion KPPBL','m',2,'-'}, ...
          {M(:,months,yrs) - VDFkppiw(:,months,yrs)-VDFkppish(:,months,yrs)-VDFwave(:,months,yrs)-VDFkppicon(:,months,yrs)-VDFnloc(:,months,yrs)-VDFkppdd(:,months,yrs), 'Vertical Diffusion KPPBL','m',2,'-'}, ...
...
% $$$ fields = { ...
% $$$           {F(:,months,yrs), 'Surface Heat Fluxes ($\mathcal{F}$)','k',2,'-'}, ...
% $$$           {P(:,months,yrs), 'Surface Heat Volume ($\mathcal{P}$)','m',2,'-'}, ...
% $$$           {PI(:,months,yrs), 'Surface Heat Fluxes ($\mathcal{P}_I$)','c',2,'-'}, ...
% $$$           {Ffz(:,months,yrs), 'Surface Heat Frazil','r',2,'-'}, ...
% $$$           {Fsw(:,months,yrs), 'Surface Heat SW','b',2,'-'}, ...
% $$$           {Fsh(:,months,yrs), 'Surface Heat SH',[0 0.5 0],2,'-'}, ...
% $$$           {Fet(:,months,yrs), 'Surface Heat ETS','k',1,'--'}, ...
% $$$           };
